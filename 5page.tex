...
enable ISPs to provide reliable packet delivery from one end host to another
...
implement the edge component of an ISP. 
...
However, due to deployment issues on VICCI relating to uncooperative network interface,
 we have to deploy all three ISPs on the University of Washington cluster.
At each cluster/ISP PoP, we will have
